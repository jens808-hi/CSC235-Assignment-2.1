...
print ("Upon searching the second hut you find an axe, coconuts, rope, duffel bag and a key.")
...
print ("You proceed back to the position on the beach you initially were and retrieve your map to examine it further.")
...
#Loop that repeats itself as long as condition is true
while(answerChoice == "no"):
    #displays output message to the user 
    print("Goodbye!")  
#displays output message to the user       
print ("Welcome to Open Water Adventure")
